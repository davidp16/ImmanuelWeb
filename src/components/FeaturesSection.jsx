...
export default function FeaturesSection() {
  return (
    <section className="py-6 sm:py-8 md:py-12 px-2 sm:px-margin-mobile md:px-margin-desktop max-w-5xl mx-auto -mt-4 sm:-mt-8 relative z-10">
      {/* App-like Container */}
      <div className="bg-surface-container-lowest sm:bg-surface rounded-3xl p-3 sm:p-8 shadow-sm sm:shadow-lg border border-outline-variant/15 sm:border-outline-variant/20">
